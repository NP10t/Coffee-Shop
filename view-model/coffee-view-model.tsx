...
import Item, { Details } from '@/model/Item';
...
export const OrderProvider = ({ children }) => {
  ...
  //       cartItem.details === coffee.details && cartItem.typeID === coffee.typeID// thêm các điều kiện khác nếu cần
  //     );
  ...
  //     Date.now(), // id
  //     "On-going", // status
  //     Number(calculateTotal()), // totalPrice
  //     [...cartItems], // items
